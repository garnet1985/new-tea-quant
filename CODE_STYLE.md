...
- **清晰优于简洁**：函数名和变量名应该自解释
- **一致优于个性**：整个项目保持统一的命名风格；同一上下文里同一事物只用一个英文名
- **标识符用英文**：变量、函数、类、模块、文件名用英文
- **注释和文档用中文**：模块 / 类 / 函数 docstring、行内注释、Markdown 用中文（面向用户的提示信息同样用中文）
...
| 版本 | 日期 | 修改内容 |
|------|------|----------|
| 1.1 | 2026-09-12 | 1.1：标识符英文；注释与文档中文 |
| 1.0 | 2026-06-26 | 初始版本 |
