...
class DataLoader:
    ...
    @staticmethod
    def prepare_data(stock: Dict[str, Any], settings: Dict[str, Any]):
        """
        ...
        #     data['corporate_finance'] = DataLoader.load_corporate_finance_data_in_child_process(corporate_finance_settings)
