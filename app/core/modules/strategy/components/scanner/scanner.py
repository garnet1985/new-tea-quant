...
from app.core.modules.strategy.components.scanner.scan_date_resolver import ScanDateResolver
from app.core.modules.strategy.components.scanner.scan_cache_manager import ScanCacheManager
from app.core.modules.strategy.components.scanner.adapter_dispatcher import AdapterDispatcher
from app.core.modules.strategy.components.setting_management.models.scanner_settings import ScannerSettings
...
class Scanner:
    ...
    def _scan_stocks(
        ...
        worker_module_path = f"app.userspace.strategies.{self.strategy_name}.strategy_worker"
