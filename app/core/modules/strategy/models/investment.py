...
from app.core.modules.strategy.models.trade import Trade
...
class PriceFactorInvestment(BaseInvestment):
    ...
    def from_opportunity(
        ...
        if trigger_date and exit_date:
            try:
                from app.core.modules.strategy.components.price_factor_simulator.helpers import parse_yyyymmdd
        ...
        if holding_days > 0:
            try:
                from app.core.modules.strategy.components.price_factor_simulator.helpers import get_annual_return
