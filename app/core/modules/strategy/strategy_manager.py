...
# Helper 组件
from app.core.modules.strategy.helper import (
...
class StrategyManager:
    ...
    def _simulate_single_strategy(self, strategy_name: str, session_id: str = None, date: str = None):
        ...
        if session_id is None:
            from app.core.modules.strategy.components.session_manager import SessionManager
    ...
    def _execute_jobs(
        ...
        """多进程执行作业"""
        from app.core.infra.worker.multi_process.process_worker import ExecutionMode as ProcessExecutionMode, ProcessWorker
