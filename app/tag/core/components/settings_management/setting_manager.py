...
class SettingsManager:
    ...
    @staticmethod
    def load_settings_from_file(settings_file_path: str) -> Dict[str, Any]:
        """
        ...
        settings = SettingsManager.read_settings_file(
            settings_path=settings_file_path,
            calculator_path=settings_file_path,
        )
        SettingsManager.apply_defaults(settings)
        return settings
    ...
    def load_and_process_settings(
        ...
        """
        # 1. 读取 settings 文件
        settings = SettingsManager.read_settings_file(settings_path, calculator_path)
