...
| strategy | `APIs/strategy`（workbench + scan） | [`strategy/workbench/ROUTES_ORCHESTRATION.md`](APIs/strategy/workbench/ROUTES_ORCHESTRATION.md) | `modules.strategy.launcher` |
