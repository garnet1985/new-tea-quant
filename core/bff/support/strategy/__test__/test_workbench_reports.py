...
from core.bff.support.strategy.report_hydrate import (
    hydrate_enum_slot,
    hydrate_portfolio_slot,
    hydrate_price_slot,
)
from core.bff.support.strategy.workbench_reports import WorkbenchReports
...
def test_hydrate_enum_slot_from_overall_report(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "core.bff.support.strategy.report_hydrate.resolve_simulation_output_dirs",
        lambda *a, **k: [out_dir],
    )
...
@patch(
    "core.bff.support.strategy.workbench_reports.WorkbenchSnapshots.fetch_by_version"
)
...
def test_build_step_report_ref_from_entity_list(mock_fetch, _mock_enrich, tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "core.bff.support.strategy.workbench_reports.resolve_simulation_output_dirs",
        lambda *a, **k: [out_dir],
    )
