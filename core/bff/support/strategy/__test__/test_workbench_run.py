...
from core.bff.support.strategy.workbench_run import WorkbenchRunLauncher
from core.bff.support.strategy.workbench_run_envelope import (
    get_run_progress,
...
@patch(
    "core.bff.support.strategy.workbench_run.read_pipeline_status",
    return_value={"busy": False},
)
@patch(
    "core.bff.support.strategy.workbench_run.DiscoveryService.find_strategy",
    return_value=None,
)
