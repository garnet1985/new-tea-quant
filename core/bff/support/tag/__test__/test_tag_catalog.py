...
from core.bff.support.tag.tag_catalog import TagCatalog
from core.bff.support.tag.tag_run import TagRunLauncher
...
@patch(
    "core.bff.support.tag.tag_catalog.DiscoveryService.discover_tags",
    return_value=[],
)
