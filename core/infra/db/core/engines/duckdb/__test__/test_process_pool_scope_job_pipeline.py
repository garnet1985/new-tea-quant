...
from core.infra.db.core.engines.duckdb.process_pool_scope import should_apply_process_pool_scope


def test_should_apply_auto_duckdb_process():
    with patch(
        "core.infra.db.core.engines.duckdb.process_pool_scope.is_duckdb_backend",
        return_value=True,
    ):
