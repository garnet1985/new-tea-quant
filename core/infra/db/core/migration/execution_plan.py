"""
将 :class:`~core.infra.db.core.migration.schema_diff.SchemaDiffResult` 编译为可顺序执行的 DDL 步骤。
...
from core.infra.db.core.migration.schema_diff import SchemaDiffResult, TableSchemaDiff
...
def plan_from_schema_diff(
    ...
    *,
    ...
    Args:
        diff: :func:`~core.infra.db.core.migration.schema_diff.diff_expected_schemas` 的结果
