"""
按 :class:`~core.infra.db.core.migration.execution_plan.ExecutionPlan` 顺序执行 DDL / 数据脚本。
...
from core.infra.db.core.migration.migration_history import is_step_applied, record_step_applied
