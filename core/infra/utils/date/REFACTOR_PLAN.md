...
# 重构后（全字符串）
from core.infra.utils.date import parser, period
...
# 重构后
from core.infra.utils.date import parser
...
# 方案 2：提供排序辅助
from core.infra.utils.date import period
...
```python
from core.infra.utils.date import parser, period, calculator
