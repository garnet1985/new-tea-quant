"""Timeline planner — price_factor dispatch from worker.json."""
...
def test_price_explicit_entities_per_job_from_worker_json() -> None:
    performance = TimelineConfig.resolve_dispatch_performance("strategy.price")
