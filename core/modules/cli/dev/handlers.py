...
class DevHandlers:
    ...
    def cmd_check_import(args: argparse.Namespace) -> int:
        cmd = [sys.executable, "-m", "core.modules.cli.dev.scripts.minimal_import_check", *args.forward]
        return subprocess.run(cmd, cwd=str(DevHandlers._repo_root())).returncode
    ...
    def cmd_sample_stock_pool(args: argparse.Namespace) -> int:
        from core.modules.cli.dev.scripts.sample_stock_list import SampleStockList
    ...
    def cmd_pack(args: argparse.Namespace) -> int:
        from core.modules.cli.dev.scripts.publish_prep import PublishPrepOptions, run_publish_prep
