...
# 系统 Loader 映射：DataKey -> Loader 类
SYSTEM_LOADER_MAPPING: Dict[DataKey, Type[BaseLoader]] = {
...
def get_system_loader(data_key: DataKey) -> Type[BaseLoader]:
    """获取系统 DataKey 对应的 Loader 类。

    Args:
        data_key: 系统 DataKey 枚举
    ...
    """
    if data_key not in SYSTEM_LOADER_MAPPING:
        raise KeyError(f"系统 DataKey {data_key} 未注册 loader")
    return SYSTEM_LOADER_MAPPING[data_key]


__all__ = ['SYSTEM_LOADER_MAPPING', 'get_system_loader']