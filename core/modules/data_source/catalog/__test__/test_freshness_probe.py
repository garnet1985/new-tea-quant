...
def test_resolve_freshness_end_aligns_configured_as_of_to_calendar():
    ...
    with patch(
        "core.modules.data_source.catalog.freshness_probe.ConfigManager.get_as_of_latest_completed_trading_date",
...
def test_needs_renew_work_refresh_stock_list_when_table_has_rows():
    ...
    with patch(
        "core.modules.data_source.service.date_range.date_range_service.DateRangeService.compute_last_update_map",
        return_value={},
    ), patch(
        "core.modules.data_source.service.date_range.date_range_service.DateRangeService.compute_entity_date_ranges",
