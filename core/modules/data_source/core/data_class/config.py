...
from core.modules.data_source.core.data_class.job_execution_config import JobExecutionConfig
from core.modules.data_source.core.data_class.renew_config import RenewConfig
...
class DataSourceConfig:
    ...
    def get_default_date_range(self) -> Dict[str, int]:
        """返回 default_date_range 配置，如 {"years": 1}（refresh 模式起点）。"""
