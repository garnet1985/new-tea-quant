...
from core.modules.data_source.core.service.executor.bundle_progress import BundleExecutionProgress
from core.modules.data_source.core.service.executor.save_batch_sizer import SaveBatchSizer
from core.modules.data_source.core.service.pipeline.save_utils import (
    BundleSaveItem,
...
class _DuckdbImmediateBatchSizer:
    ...
    def __init__(self, config: DataSourceConfig, total_bundles: int) -> None:
        if config.is_save_batch_size_auto():
            from core.modules.data_source.core.service.executor.save_batch_auto_sizer import (
                SaveBatchAutoSizer,
            )
