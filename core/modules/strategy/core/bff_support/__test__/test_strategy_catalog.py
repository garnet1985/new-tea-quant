...
from core.modules.strategy.core.bff_support.strategy_catalog import StrategyCatalog
...
@patch(
    "core.modules.strategy.core.bff_support.strategy_catalog.DiscoveryService.discover_strategies",
    return_value=[],
)
