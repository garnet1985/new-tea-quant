...
from core.modules.strategy.core.bff_support.workbench_run import WorkbenchRunLauncher
from core.modules.strategy.core.bff_support.workbench_run_envelope import (
    get_run_progress,
...
@patch(
    "core.modules.strategy.core.bff_support.workbench_run.read_pipeline_status",
    return_value={"busy": False},
)
@patch(
    "core.modules.strategy.core.bff_support.workbench_run.DiscoveryService.find_strategy",
    return_value=None,
)
