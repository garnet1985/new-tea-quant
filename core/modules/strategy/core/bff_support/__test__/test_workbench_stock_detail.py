...
from core.modules.strategy.core.bff_support.workbench_stock_detail import (
...
@patch(
    "core.modules.strategy.core.bff_support.workbench_stock_detail.WorkbenchSnapshots.fetch_by_version"
)
...
def test_resolve_output_dir_requires_entity_csv(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "core.modules.strategy.core.bff_support.workbench_stock_detail.resolve_simulation_output_dirs",
        lambda *a, **k: [out_dir],
    )
