...
class Opportunity:
    ...
    def bind_scan_context(
        ...
        *,
        ...
        trigger_price_hfq: Optional[float] = None,
        ...
        if trigger_price_hfq is not None:
            self.trigger_price_hfq = float(trigger_price_hfq)
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Opportunity":
        ...
        trigger_price_hfq = cls._to_float(raw.get("trigger_price_hfq"), 0.0)
        return cls(
            stock=stock,
