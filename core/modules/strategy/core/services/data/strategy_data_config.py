...
from core.modules.data_contract.kline_keys import STOCK_KLINE_DATA_ID_VALUES, kline_term_from_data_id_value
...
class StrategyDataConfig:
    ...
    def storage_key_for(data_key: DataKey, *, is_base: bool = False) -> str:
        ...
        from core.modules.data_contract.kline_keys import PRIMARY_KLINE_SLOT, is_stock_kline_data_key
