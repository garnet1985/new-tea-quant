...
from core.modules.strategy.launcher.strategy_catalog import StrategyCatalog
...
@patch(
    "core.modules.strategy.launcher.strategy_catalog.DiscoveryService.discover_strategies",
    return_value=[],
)
