...
from core.modules.strategy.launcher.workbench_reports import WorkbenchReports
...
@patch(
    "core.modules.strategy.launcher.workbench_reports.WorkbenchSnapshots.fetch_by_version"
)
...
def test_build_step_report_ref_from_entity_list(mock_fetch, _mock_enrich, tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "core.modules.strategy.launcher.workbench_reports.resolve_simulation_output_dirs",
        lambda *a, **k: [out_dir],
    )
