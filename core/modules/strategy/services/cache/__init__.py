...
- **枚举器适配器**：``sanitize_enum_payload_for_snapshot``（``simulator_res_db_cache.enumerator_adapter``）。
...
from .simulator_res_db_cache import sanitize_enum_payload_for_snapshot
