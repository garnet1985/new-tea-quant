...
from core.modules.strategy_legacy.engines.simulator.enumerator.calendar_sliced.runtime.memory_budget import (
...
def is_duckdb_backend() -> bool:
    try:
        ...
        bt = str(ProjectContext.config.load_database_config().get("database_type") or "").lower()
        return "duck" in bt
    except Exception:
        return False
