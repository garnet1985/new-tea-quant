...
from core.modules.tag.core.bff_support.tag_catalog import TagCatalog
from core.modules.tag.core.bff_support.tag_run import TagRunLauncher
...
@patch(
    "core.modules.tag.core.bff_support.tag_catalog.DiscoveryService.discover_tags",
    return_value=[],
)
