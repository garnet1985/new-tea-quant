"""
data_stock_kline_weekly 表 Model
"""
from typing import List, Dict, Any, Optional
from core.infra.db import DbBaseModel

from core.tables.data_stock_kline_weekly.schema import schema as _schema


class DataStockKlineWeeklyModel(DbBaseModel):
    """周 K 线表 Model（表名 data_stock_kline_weekly）"""
