"""
data_stock_kline_monthly 表 Model
"""
from typing import List, Dict, Any, Optional
from core.infra.db import DbBaseModel

from core.tables.data_stock_kline_monthly.schema import schema as _schema


class DataStockKlineMonthlyModel(DbBaseModel):
    """月 K 线表 Model（表名 data_stock_kline_monthly）"""
