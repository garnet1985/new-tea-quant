...
class InvestmentApi:
    ...
    def __init__(self, data_mgr=None):
        self.data_mgr = data_mgr or DataManager()
    ...
    def get_all_closed_trades(self):
        ...
        try:
            ...
            for trade in trades:
                ...
                stock_details = self.data_mgr.get_stock_with_latest_price(stock_id) or {}
    ...
    def get_all_open_trades(self):
        ...
        try:
            ...
            for trade in trades:
                ...
                next_targets = None
                try:
                    from core.modules.data_manager.data_services.ui_transit.investment.target_calculator import TargetCalculator
        ...
        try:
            ...
            if 'strategy' in data and data['strategy']:
                try:
                    ...
                    strategies_dir = os.path.join(str(REPO_ROOT), 'userspace', 'strategies')
