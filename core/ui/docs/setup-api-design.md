...
```json
{
  "id": "db_connection",
  "name": "DB 配置检查/填写",
  "description": "对应 core/infra/setup/core/steps/db_connection 的前置配置检查。",
  "requiredUserInputs": [
    {
      "key": "dbType",
      "label": "Database Type",
    ...
    "steps": [
      {
        "id": "resolve_deps",
        "name": "依赖安装",
        "description": "对应 core/infra/setup/core/steps/resolve_deps 步骤。",
        "requiredUserInputs": []
      },
      {
        "id": "init_userspace",
        "name": "Init Userspace",
        "description": "对应 core/infra/setup/core/steps/init_userspace 步骤。",
        "requiredUserInputs": [
      ...
      },
      {
        ...
        "description": "对应 core/infra/setup/core/steps/import_data 步骤。",
        "requiredUserInputs": []
      }
    ]
  }
