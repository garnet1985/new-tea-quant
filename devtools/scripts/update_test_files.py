...
def batch_update_test_files():
    """批量更新所有测试文件"""
    test_files = [
        "core/infra/project_context/__test__/test_path_manager.py",
        "core/infra/project_context/__test__/test_file_manager.py",
